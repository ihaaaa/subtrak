...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <aside 
      className={cn(
        "sidebar w-64 bg-card border-r border-border flex-shrink-0 sidebar-transition fixed md:relative h-full z-30",
        isOpen && "open"
      )}
    >
      <div className="p-6">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span className="font-semibold text-lg">SubTrak</span>
        </div>
